"""Read BP_RItual_RaiseDead, dump full node text + print a compact navigable view."""
import sys
sys.path.insert(0, r"C:\Users\sugar\devel\conan")
import bp_bridge as bp
import bp_compact as bc

ASSET = "/Game/Sorcery/Rituals/BP_RItual_RaiseDead"
FULL = ASSET + "." + ASSET.rsplit("/", 1)[1]
OUT = r"C:\Users\sugar\devel\conan\dump_BP_Ritual_RaiseDead.txt"
