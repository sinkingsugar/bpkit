"""bpkit.author - build Blueprint copy/paste node text declaratively.

Pairs with bpkit.bridge: you describe nodes + wires, render() emits the import text,
and bridge.inject() pastes + compiles it. You only specify intent (the
