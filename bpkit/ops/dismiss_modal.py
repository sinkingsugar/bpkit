...
Usage:
    python bpkit/ops/dismiss_modal.py probe     # list editor windows, detect modal (safe)
    python bpkit/ops/dismiss_modal.py enter     # dismiss via Enter (default button)
    python bpkit/ops/dismiss_modal.py esc       # dismiss via Escape (cancel)
"""
import sys, ctypes
